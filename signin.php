...
<div class="container size ">
    ...
    <div class="form-group">
        ...
        <input type="text" name="email_phone" class="form-control" placeholder="Email Or Phone" required value="<?php echo isset($_POST['email_phone']) ? htmlspecialchars($_POST['email_phone']) : ''; ?>">
    </div>
    <div class="form-group">
